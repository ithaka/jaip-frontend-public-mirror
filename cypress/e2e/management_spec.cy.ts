  ...
  context('For admins', () => {
    ...
    context('When logged in with add_group', () => {
      ...
      it('Has group management panel', () => {
        cy.get('pep-pharos-tab')
          .contains('Groups', { matchCase: false })
          .should('be.visible')
      })
    ...
    context('When logged in with reactivate_group', () => {
      ...
      it('Allows reactivating', () => {
        ...
        cy.get('#reactivate-group-modal').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with manage_superusers', () => {
      ...
      it('Has user management panel', () => {
        cy.get('pep-pharos-tab')
          .contains('Users', { matchCase: false })
          .should('be.visible')
      })

      it('Does not have group admin button', () => {
        cy.contains('Make Group Admin', { matchCase: false })
          .should('not.exist')
    ...
    context('When logged in with add_subdomain', () => {
      ...
      it('Has subdomain management panel', () => {
        cy.get('pep-pharos-tab')
          .contains('Subdomains', { matchCase: false })
          .should('be.visible')
      })
    ...
    context('When logged in with edit_subdomain', () => {
      ...
      it('Allows editing', () => {
        ...
        cy.get('#edit-subdomain-modal-2').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with delete_subdomain', () => {
      ...
      it('Allows deleting', () => {
        ...
        cy.get('#delete-subdomain-modal-2').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with add_subdomain and inactive subdomains', () => {
      ...
      it('Allows reactivating', () => {
        ...
        cy.get('#reactivate-subdomain-modal-2').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with add_feature', () => {
      ...
      it('Has features management panel', () => {
        cy.get('pep-pharos-tab')
          .contains('Features', { matchCase: false })
          .should('be.visible')
      })
    ...
    context('When logged in with edit_feature', () => {
      ...
      it('Allows editing', () => {
        ...
        cy.get('#edit-feature-modal-1').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with delete_feature', () => {
      ...
      it('Allows deleting', () => {
        ...
        cy.get('#delete-feature-modal-1').contains('Submit', { matchCase: false }).should('be.visible')
    ...
    context('When logged in with add_feature and inactive features', () => {
      ...
      it('Allows reactivating', () => {
        ...
        cy.get('#reactivate-subdomain-modal-15').contains('Submit', { matchCase: false }).should('be.visible')
