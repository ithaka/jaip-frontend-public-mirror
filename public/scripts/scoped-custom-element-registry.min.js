...
*/
  ...
  function p(a, b) {
    if (b)
      a: {
        ...
        e = d[a]
        b = b(e)
        b != e && null != b && l(d, a, { configurable: !0, writable: !0, value: b })
      }
  }
  p('Symbol', function (a) {
    function b(c) {
    ...
    function d(c, f) {
      this.l = c
      l(this, 'description', { configurable: !0, writable: !0, value: f })
    }
    if (a) return a
  ...
  var t =
    ...
    ba = (function () {
      ...
      return function (d, e, c) {
        ...
        return Function.prototype.apply.call(d, c, e) || c
      }
    })(),
    v
  ...
  if (void 0 === (null == (A = z.CustomElementRegistryPolyfill) ? void 0 : A.formAssociated)) {
    var B = {}
    z.CustomElementRegistryPolyfill = ((B.formAssociated = new Set()), B)
  }
  var C = window.HTMLElement,
    da = window.customElements.define,
    ea = window.customElements.get,
    D = window.customElements,
    E = new WeakMap(),
    F = new WeakMap(),
    G = new WeakMap(),
    H = new WeakMap()
  ...
  I.prototype.define = function (a, b) {
    a = a.toLowerCase()
    if (void 0 !== this.h.get(a))
      throw new DOMException(
        "Failed to execute 'define' on 'CustomElementRegistry': the name \"" +
          a +
          '" has already been used with this registry',
      )
    if (void 0 !== this.m.get(b))
      throw new DOMException(
        "Failed to execute 'define' on 'CustomElementRegistry': this constructor has already been used with this registry",
      )
    var d = b.prototype.attributeChangedCallback,
      e = new Set(b.observedAttributes || [])
    ha(b, e, d)
    var c = ea.call(D, a),
      f,
      g,
      h =
        null != (g = null == (f = c) ? void 0 : f.s)
          ? g
          : b.formAssociated || z.CustomElementRegistryPolyfill.formAssociated.has(a)
    h && z.CustomElementRegistryPolyfill.formAssociated.add(a)
    if (h != b.formAssociated)
      try {
        b.formAssociated = h
      } catch (u) {}
    d = {
    ...
    if ((c = this.i.get(a)))
      for (this.i.delete(a), c = q(c), e = c.next(); !e.done; e = c.next())
        ((e = e.value), F.delete(e), J(e, d, !0))
    c = this.j.get(a)
  ...
  function ia(a) {
      ...
      a: {
        ...
        if (!(e === document || e instanceof ShadowRoot)) {
          ...
          e === document ||
            ...
            (e = (null == (c = H.get(e)) ? void 0 : c.getRootNode()) || document)
        }
        c = e.registry
      }
    ...
    n.Object.defineProperty(b, 'formAssociated', {
      configurable: !0,
      enumerable: !0,
      get: function () {
    ...
    b.prototype.connectedCallback = function (d) {
      ...
      N(this)
      ;(c = E.get(this))
        ? c.connectedCallback && c.connectedCallback.apply(this, e)
        : L(F.get(this), this, a, !0)
    }
    b.prototype.disconnectedCallback = function (d) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c]
      ;(c = E.get(this))
        ? c.disconnectedCallback && c.disconnectedCallback.apply(this, e)
        : L(F.get(this), this, a, !1)
    }
  ...
  function ha(a, b, d) {
    if (0 !== b.size && void 0 !== d) {
      ...
      e &&
        (a.prototype.setAttribute = function (g, h) {
          N(this)
          g = g.toLowerCase()
          if (b.has(g)) {
      ...
      c &&
        (a.prototype.removeAttribute = function (g) {
          N(this)
          g = g.toLowerCase()
          if (b.has(g)) {
      ...
      f &&
        (a.prototype.toggleAttribute = function (g, h) {
          N(this)
          g = g.toLowerCase()
          if (b.has(g)) {
            var u = this.getAttribute(g)
  ...
  function P(a, b) {
    var d
    null == (d = O) || d.delete(a)
    b.attributeChangedCallback &&
      b.observedAttributes.forEach(function (e) {
        a.hasAttribute(e) && b.attributeChangedCallback.call(a, e, null, a.getAttribute(e))
      })
  }
  function Q(a) {
    var b = Object.getPrototypeOf(a)
    if (b !== window.HTMLElement)
      return b === C ? Object.setPrototypeOf(a, window.HTMLElement) : Q(b)
  }
  function J(a, b, d) {
    d = void 0 === d ? !1 : d
  ...
  if (window.ElementInternals && window.ElementInternals.prototype.setFormValue) {
    var U = new WeakMap(),
      V = HTMLElement.prototype.attachInternals,
    ...
    methods.forEach(function (a) {
      var b = window.ElementInternals.prototype,
        d = b[a]
      b[a] = function (e) {
        for (var c = [], f = 0; f < arguments.length; ++f) c[f] = arguments[f]
        f = U.get(this)
        if (!0 === E.get(f).formAssociated)
          return null == d ? void 0 : d.call.apply(d, [this].concat(r(c)))
        throw new DOMException(
          'Failed to execute ' +
            d +
    ...
    W.u = X.prototype
    n.Object.defineProperty(RadioNodeList.prototype, 'value', {
      configurable: !0,
      enumerable: !0,
      get: function () {
        var a
    ...
    var HTMLFormControlsCollection = function (a) {
      ...
      d.forEach(function (e, c) {
        e &&
          ...
          'item' !== c &&
          'namedItem' !== c &&
          (b[c] = 1 === e.length ? e[0] : new RadioNodeList(e))
      })
    }
    ...
    Object.defineProperty(HTMLFormElement.prototype, 'elements', {
      get: function () {
        var a = ja.get.call(this),
          b = []
        a = q(a)
        for (var d = a.next(); !d.done; d = a.next()) {
          d = d.value
          var e = E.get(d)
          ;(e && !0 !== e.formAssociated) || b.push(d)
        }
